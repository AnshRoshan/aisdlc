...
2. Load the skill it names (`aisdlc-brainstorm`, `aisdlc-brownfield`, `aisdlc-debug`, `aisdlc-delta`, `aisdlc-discover`, `aisdlc-flow`, `aisdlc-grill`, `aisdlc-handoff`, `aisdlc-implement`, `aisdlc-plan`, `aisdlc-ponytail`, `aisdlc-release`, `aisdlc-retro`, `aisdlc-review`, `aisdlc-spec`, `aisdlc-tasks`, `aisdlc-taste`, `aisdlc-verify`). Start with `aisdlc-flow` when unsure, `aisdlc-brainstorm` for a new idea, `aisdlc-debug` for a bug.
