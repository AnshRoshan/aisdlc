...
| Skills assumed `npx aisdlc` always works | hardening | `aisdlc-flow` gained a manual derivation procedure and a manual-evidence protocol for sandboxes without the CLI. |
